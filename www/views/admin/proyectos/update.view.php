    ...
    <form class="row needs-validation" id="myForm" novalidate>
        <div class="card-body">
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <?= $renderer->renderElement($form->getElement('evento_id')) ?>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="row my-4">
                ...
                <div class="col-md-6">
                    <a class="btn btn-outline-danger form-control my-2" href="<?= $btnCancelar ?>"
...
<script>
    ...
    window.onload = function() {
        ...
        const formHandler = new FormHandler('myForm', '/eventos/evento/update', (response) => {
