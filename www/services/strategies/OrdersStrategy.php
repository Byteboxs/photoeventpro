...
<div class="d-flex justify-content-start align-items-center user-name">
    <div class="avatar-wrapper">
        <div class="avatar avatar-sm me-4">
            <span class="avatar-initial rounded-circle pull-up text-heading bg-label-success">GI</span>
        </div>
    </div>
    <div class="d-flex flex-column">
        <span class="fw-large">GRADUACIÓN INGENIERIA DE SISTEMAS 2025-2</span>
