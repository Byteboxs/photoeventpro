...
use app\models\ui\menu\SubmenuItem;

class UIAdminMenu implements UIMenuInterface
{
    private $html = '';
    private $appPath;
    ...
    public function build(): void
    {
        ...
        $menuBuilder->addItem(new BadgeMenuItem('Nuevos inscritos', 'fas fa-file-alt', $this->appPath . '/nuevosRegistros', '2', 'badge-warning'));
        $menuBuilder->addItem(new BadgeMenuItem('Citas', 'fas fa-calendar-alt', $this->appPath . '/citasPendientes', '10', 'badge-warning'));
        $menuBuilder->addItem(new BadgeMenuItem('Clientes', 'far fa-address-card', $this->appPath . '/clientes', '?', 'badge-info'));
